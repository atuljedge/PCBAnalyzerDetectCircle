...
void CPCBAnalyzerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CPCBAnalyzerApp customization load/save methods

void CPCBAnalyzerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CPCBAnalyzerApp::LoadCustomState()
{
}

void CPCBAnalyzerApp::SaveCustomState()
{
}
